...
6. **logo-hybrid-stacked.svg** - Vertical version of hybrid
...
### Stacked Logo
- Use `logo-hybrid-stacked.svg` for square/vertical formats
- Minimum width: 150px
...
/assets
  ...
  /logo-stacked.png - Use logo-hybrid-stacked.svg
```
