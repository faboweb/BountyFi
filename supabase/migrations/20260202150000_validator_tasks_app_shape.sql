-- Migration: Validator tasks return shape expected by app (before_photo_url, after_photo_url, gps_*) and include PENDING
-- Verify screen uses get_tasks -> get_validator_tasks_by_wallet; app expects Submission[] with before_photo_url, after_photo_url, gps_lat, gps_lng.
